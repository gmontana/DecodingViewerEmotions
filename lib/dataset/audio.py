...
def get_audio_x( record, args , mode_train_val):
    ...
    audio_augmentation_param, audio_img_param = args["dataset"]["audio_augmentation"], args["dataset"]["audio_img_param"]
    ...
    if args["audio_segments"] == 2:
        if waveform.size()[0] > 1:
            X_mel = wafeform_to_spectrogram_torch(waveform[1], sr, audio_img_param)
