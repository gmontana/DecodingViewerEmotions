...
def main():
    ...
    dirs_p1 = [
        ...
        ["RGB_audio", "4", "INET21K",
            "logs/screen_multiclass_may/ad_timm_16f_8f_4f_j05_BG4000/0_1_2_3_4_5_6_7_8_0.5_0.5_0.1_1_resnet50_timm_4_0_1_adcumen"],
        ...
        ["RGB_audio", "8", "INET21K",
            "logs/screen_multiclass_may/ad_timm_16f_8f_4f_j05_BG4000/0_1_2_3_4_5_6_7_8_0.5_0.5_0.1_1_resnet50_timm_8_0_1_adcumen"],
    ...
    for i, [modality, frames, pretrained, dir] in enumerate(dirs_p1):
        ...
        for mode in mode_train_val:
            ...
            with open(file_results) as f:
                results = json.load(f)
                results_screen[i][mode] = [
                    modality, frames, pretrained, results]
